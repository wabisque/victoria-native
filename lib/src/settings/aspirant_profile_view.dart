...
class AspirantProfileView extends StatefulWidget {
  static const String routeName = '/settings/aspirant-profile';

  const AspirantProfileView({
    super.key
  });

  @override
  State<AspirantProfileView> createState() => _AspirantProfileViewState();
}

class _AspirantProfileViewState extends State<AspirantProfileView> with RouteAware {
  File? _flyer;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ImagePickerWidget(
                        ...
                        placeholder: Image.network(authenticationProvider.user!.aspirant!.flyer.toString())
                      ),
                              ...
                              onPressed: () async {
                                ...
                                try {
                                  final http.MultipartRequest request = http.MultipartRequest(
                                    'POST',
                                    Uri.parse('${Constants.apiHost}/api/aspirants?_method=PUT')
                                  );
  ...
  void initState() {
    ...
    _addressFieldController = TextEditingController(
      text: authenticationProvider.user!.aspirant!.address
    );
    _constituencyId = authenticationProvider.user!.aspirant!.constituency!.id;
    _partyId = authenticationProvider.user!.aspirant!.party!.id;
    _positionId = authenticationProvider.user!.aspirant!.position!.id;
